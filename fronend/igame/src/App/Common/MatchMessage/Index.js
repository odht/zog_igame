    ...
    render() {
        const tabs = [
            { title: <Badge>首页</Badge>,             
                content:<DetailsHome match={this.props.match}
                                    toSignMatch={this.props.toSignMatch}
                                    name={this.props.name} />
            },
            { title: <Badge>参赛队</Badge>,                
              content:<MatchTeam match={this.props.match} /> 
            },
            { title: <Badge dot>赛程</Badge>,              
                content:<Course match={this.props.match} 
            ...
            { title: <Badge>数据</Badge>,                  
                content:<MatchData match={this.props.match} /> 
            },
            { title: <Badge text={'3'}>新闻</Badge>,       
                content:<News match={this.props.match} /> 
            },
        ];
        return(
            <div>
