...
SearchForm = connect(({advertiser})=>({advertiser}))(SearchForm);
...
class TableList extends Component{
    ...
    onCheck = (record) => {
        ...
        router.push({
            pathname:'/management/advertise/advertiseInfo',
            query:record
        });
    }
    ...
    render(){
        ...
        const {advertiser:{list},form:{getFieldDecorator}} = this.props;
        console.log('-------- advertiser_props --------',this.props);
...
TableList = connect(({advertiser})=>({advertiser}))(TableList);
