...
import ogBoard from './ogBoardApi';
...
const models = {
  ...
  ogChannel:{ default: [
    'name','type','table_id','mail_channel_id'
  ]},
...
export default ( {model} ) => {
  ...
  const api = apis[namespace] ? apis[namespace] : baseApi
  const fields = models[namespace]
  const myapi = api({model,fields})
